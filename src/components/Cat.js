...
const Cat = () => {
  return (
    <div id="cats-container">
      ...
      />
      <CatContainer
        image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQoWVK7qM19AS14E2eLtqWUAP3iAlS_Rtx_sg&usqp=CAU"
        name="Cat 4"
        age={2}
      />
    </div>
